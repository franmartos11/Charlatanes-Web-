            ...
            <ul className="">
                ...
                <li className="text-left mb-10">
                    <div className="flex flex-row items-start mb-5">
                        ...
                        <div className="bg-gray-100 p-5 rounded px-10 w-full flex items-center">
                    ...
                    <div className="flex flex-row items-start">
                        <div className="bg-indigo-100 rounded p-5 px-10 w-full flex items-center">
                ...
                <li className="text-left mb-10">
                    <div className="flex flex-row items-start mb-5">
                        ...
                        <div className="bg-gray-100 rounded p-5 px-10 w-full flex items-center">
                            <h4 className="text-md leading-6 font-medium text-gray-900">What could possibly be your first
                                question?</h4>
                        </div>
                    </div>
